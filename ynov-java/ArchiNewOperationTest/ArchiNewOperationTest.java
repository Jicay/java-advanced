...
public class ArchiNewOperationTest {
    ...
    void testClassController() {
        ...
        try {
            Constructor constructor = ComputeController.class.getDeclaredConstructor(ComputeService.class);
            assertThat(Modifier.isPublic(constructor.getModifiers()))
                    .withFailMessage("Constructor should be public")
                    .isTrue();
        } catch (NoSuchMethodException e) {
    ...
    @Test
    void add() throws IOException, URISyntaxException, InterruptedException {
